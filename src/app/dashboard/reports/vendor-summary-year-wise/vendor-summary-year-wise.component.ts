...
@Component({
  selector: 'app-vendor-summary-year-wise',
  templateUrl: './vendor-summary-year-wise.component.html',
  styleUrls: ['./vendor-summary-year-wise.component.css']
})
export class VendorSummaryYearWiseComponent implements OnInit {
  ...
  getData(payload:any) {
    ...
    this.reportService.getVendorSummaryYearwiseCummulative(payload).subscribe({
      next: (res: any) => {
       this.data = res;
