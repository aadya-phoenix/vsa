...
@Component({
  selector: 'app-section-head-reject',
  templateUrl: './section-head-reject.component.html',
  styleUrls: ['./section-head-reject.component.css']
})
export class SectionHeadRejectComponent implements OnInit {
