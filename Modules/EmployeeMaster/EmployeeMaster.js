...
app.service('EmployeeMasterService', function ($http, $location, $rootScope) {
...
app.controller('EmployeeMasterController', function ($scope, $http, $location, EmployeeMasterService,
  $rootScope, $uibModal, $filter) {

  $scope.EmpMaster = true;
  $scope.EmpMasterDetail = false;
  ...
  //};
  $scope.Save = function () {
    new swal("Employee Details Added Successfully");
  };

  $scope.AddEmployee = function () {
    $scope.EmpMaster = false;
    $scope.EmpMasterDetail = true;
  };
