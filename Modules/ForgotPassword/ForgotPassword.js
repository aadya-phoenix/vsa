var app = angular.module('ForgotPasswordModule', []);

app.service('ForgotPasswordService', function ($http, $location, $rootScope) {
...
app.controller('ForgotPasswordController', function ($scope, $http, $location, ForgotPasswordService,
  ...
  $scope.GetDataOnInit = function () {
    ForgotPasswordService.GetStaticContent('ForgotPassword').then(function (success) {
  ...
  $scope.UpdateRule = function () {
    $scope.Content.DataType = 'ForgotPassword';
    ForgotPasswordService.UpsertStaticContent($scope.Content).then(function (success) {
      swal(success.data);
    }, function (error) {
      console.log(error);
    });
