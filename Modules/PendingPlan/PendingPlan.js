...
app.service('PendingPlanService', function ($http, $location, $rootScope) {
...
app.controller('PendingPlanController', function ($scope, $http, $location, PendingPlanService,
  $rootScope, $uibModal, $filter) {

  $scope.Pending = true;
  $scope.PendingPlanDetail = false;
  ...
  $scope.PendingPlan = function () {
    $scope.Pending = false;
    $scope.PendingPlanDetail = true;
  };
