using MarutiSuzuki.Audit.Logging;
		...
		private async Task HandleExceptionAsync(HttpContext context, Exception exception)
		{
			...
			switch (exception.Message)
			{
				case UnauthorizedAccess:
                    ...
                    Logger.Log(LogType.INFO, "ErrorHandlingMiddleware", "HandleExceptionAsync", exception.InnerException == null ? exception.Message : exception.InnerException.Message, exception.StackTrace);
					break;
